    ...
    <Suspense fallback={<div>Loading...</div>}>
      <div className="mx-auto bg-black max-w-[100%] sm:w-[100%] select-none">
        <div className="flex pb-9 pt-0 px-4 sm:px-[24px] justify-between items-end">
          ...
          <div className="text-6xl md:text-6xl lg:8xl mb-0 font-neue-roman text-radial-gradient text-start transform translate-y-5 hidden custom-max1300:block ">FAQs</div>
          <div className="text-6xl md:text-6xl lg:8xl mb-0 font-neue-roman text-radial-gradient text-start transform translate-y-5 block custom-max1300:hidden ">Frequently Asked Questions</div>
