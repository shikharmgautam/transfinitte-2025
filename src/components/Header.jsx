...
const Header = () => {
  return (
    ...
    <div className="flex items-center gap-10 sticky top-4 z-50">
      <span className="relative inline-block overflow-hidden rounded-3xl p-[1px] left-1/2 transform -translate-x-1/2">
        ...
        <div className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-3xl bg-gray-950 px-3 py-4 text-xs font-medium text-gray-50 backdrop-blur-3xl gap-x-12">
