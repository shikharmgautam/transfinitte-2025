...
const Hero = () => {
  return (
    <section
      id="hero"
      className="w-full min-h-[120vh] flex flex-col items-center justify-center px-4 sm:px-8 md:px-10 lg:px-25 py-14"
    >
      <div className="relative flex flex-col-reverse sm:flex-row items-center justify-center w-full gap-4 md:gap-8 mt-3 mb-0">
        ...
        <div className="flex-1 flex flex-col items-start justify-center text-left lg:mr-[20vw] md:ml-0 lg:ml-30 transform translate-y-60 sm:translate-y-0">
          ...
          <p
            className="mt-2 text-l sm:text-xl text-white"
            style={{
              fontFamily:
                "Neue Haas Grotesk Roman, Inter, system-ui, sans-serif",
            }}
          ></p>
          <button
          ...
          <div className="w-full p-24 sm:p-0" />
        </div>
      </div>
    </section>
  );
