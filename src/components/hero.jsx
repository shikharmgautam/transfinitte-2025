    ...
    <>
      ...
      >
        ...
        <img 
          src={heroOne} 
          alt="Hero One" 
          className="absolute top-0 left-1/2 transform md:-translate-y-[2vh] lg:-translate-y-[5vh] -translate-x-1/2 w-auto h-30vh max-w-full object-contain"
          style={{ zIndex: 10 }}
        />
    
        <div className="hidden sm:flex items-center justify-center gap-1 absolute left-1/2 top-18 -translate-y-[10vh] -translate-x-1/2 z-20 font-neue-xxthin m-0 p-0 overflow-hidden">
